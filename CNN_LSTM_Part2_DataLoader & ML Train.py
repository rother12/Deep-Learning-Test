...
# Build data loader
custom_data_loader = get_loader("/home/wonsik.jung/coco_dataset/cocodataset/resized_images", "/home/wonsik.jung/coco_dataset/annotations/captions_train2014.json", vocabulary, 
                         transform, 128,
    ...
    for i, (imgs, caps, lens) in enumerate(custom_data_loader):
        ...
        if (i+1) % 1000 == 0:
            ...
            torch.save(decoder_model.state_dict(), os.path.join(
                'home/wonsik.jung/coco_dataset/', 'decoder-{}-{}.ckpt'.format(epoch+1, i+1)))
            torch.save(encoder_model.state_dict(), os.path.join(
                'home/wonsik.jung/coco_dataset/', 'encoder-{}-{}.ckpt'.format(epoch+1, i+1)))
